...
*v1.2.1 · 2026-08-14* · [release notes](docs/releases/v1.2.1.md) · [Tone Pack and shareable Preset guide](docs/tone-file-management.md)
...
Pinned versions (v1.2.1). Update `requirements.txt` and the NeuralAudio commit
