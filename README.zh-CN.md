...
*v1.2.2 · 2026-08-14* · [发布说明](docs/releases/v1.2.2.md) · [Tone Pack 与分享 preset 完整使用指南](docs/tone-file-management.zh-CN.md)
...
版本固定（v1.2.2）。升级时需同步更新 `requirements.txt` 与 `install.sh`
